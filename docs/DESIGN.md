...
| Pilots | Sync / loyalty / stress on HUD with procedural portrait plaques; AT Field shatter spikes stress / dips sync; high sync buffs damage, reads Angel cores, and core-strikes for bonus damage; stress / refuse / steady / sparse core-sight dialog beats + disobedience |
