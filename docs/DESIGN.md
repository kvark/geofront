...
| Aliens | Splinter kite + Mass pressure; Mass AT Field absorbs first hits; Angel FX until real art |
...
| Pilots | Sync / loyalty / stress already on HUD; portraits, dialogs, disobedience next |
...
4. Do Angels read vs mechs (silhouette/FX, AT Field cyan cage) without new meshes?
