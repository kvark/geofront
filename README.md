...
- **(low–med) Characters** — pilots carry sync/loyalty/stress; wrecked limbs / near-death spike stress and may skip the next order; high sync buffs damage/crit, low sync weakens strikes; portraits and dialogs still ahead.
