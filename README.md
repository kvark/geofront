...
- **(low–med) Characters** — pilots carry sync/loyalty/stress; wrecked limbs / near-death spike stress and may skip the next order with Eva-flavored refuse drama lines + HUD flash; high sync buffs damage/crit, low sync weakens strikes; portraits and full dialogs still ahead.
